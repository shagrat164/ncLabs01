...
//        train4.addTimetable("2016-12-04 08:00", 15, 40);
//        train4.addTimetable("2016-12-05 08:00", 15, 40);
//        train4.addTimetable("2016-12-06 08:00", 15, 40);
//        train4.addTimetable("2016-12-07 08:00", 15, 40);
//        train4.addTimetable("2016-12-08 08:00", 15, 40);
//        train4.addTimetable("2016-12-09 08:00", 15, 40);
//        train4.addTimetable("2016-12-10 08:00", 15, 40);
//
//        ElectricTrain train5 = new ElectricTrain(1550, route4);
//        train5.addTimetable("2016-12-05 09:00", 3);
//        train5.addTimetable("2016-12-05 12:00", 3);
//        train5.addTimetable("2016-12-05 15:00", 3);
//        train5.addTimetable("2016-12-05 18:00", 3);
//
//        ElectricTrain train6 = new ElectricTrain(1670, route5);
//        train6.addTimetable(LocalDateTime.now(), 12);
//
//        electricTrains.add(train1);
//        electricTrains.add(train2);
//        electricTrains.add(train3);
//        electricTrains.add(train4);
//        electricTrains.add(train5);
//        electricTrains.add(train6);
    }
